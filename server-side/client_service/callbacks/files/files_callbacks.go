...
// UpdateFile verifies the the validity of the token and the request body
// If token is valid, redirects the request to files service
func UpdateFile(w http.ResponseWriter, r *http.Request) {
	...
	token := r.Header.Get("Authorization")
	var updateBody datastructures.UpdateBody
	var userdata datastructures.UserData
	...
	if !utils.VerifyAuthorization(updateBody.Workspace, userdata) {
		log.Println("Unauthorized")
		w.WriteHeader(http.StatusUnauthorized)
		return
	}
